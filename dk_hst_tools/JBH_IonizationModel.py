...
def get_JBH_MW_IonizingFlux(c, data_filename = None):
    ...
    if data_filename == None:
        ...
        data_filename = os.path.join(directory,"data/JBH_RadiationField/JBH_mw_ionizing_field.txt")
...
def get_JBH_LMC_IonizingFlux(c, lmc_par = None, LMC_coord = None):
    """
...
def MW_LMC_SMC_IonizingFlux(c, data_filename = None, lmc_par = None, smc_par =None, 
    ...
    res["MW"] = get_JBH_MW_IonizingFlux(c, data_filename = data_filename)
    res["LMC"] = get_JBH_LMC_IonizingFlux(c, lmc_par = lmc_par, LMC_coord = LMC_coord)
    res["SMC"] = get_JBH_SMC_IonizingFlux(c, smc_par = smc_par, SMC_coord = SMC_coord)
